...
uint32_t GrPathUtils::generateShapedCubicPoints(
    ...
    if (innerIsLine == true && outerIsLine == true) {
        ...
        *points += 3;
        ...
        SkPoint outerS = { SkScalarAve(outerR[0].fX, outerR[1].fX),
                           SkScalarAve(outerR[0].fY, outerR[1].fY) };
        ...
        SkPoint innerS = { SkScalarAve(innerR[0].fX, innerR[1].fX),
                           SkScalarAve(innerR[0].fY, innerR[1].fY) };
