...
extern const GrVertexAttrib gHairLineVertexAttribs[] = {
    ...
    {kUByte_GrVertexAttribType, sizeof(SkPoint) + sizeof(uint8_t) * 4, kCoverage_GrVertexAttribBinding}
};
...
bool GrHairLinePathRenderer::internalDrawPath(const SkPath& path,
    ...
    uint8_t coverage = drawState->getCoverage();
