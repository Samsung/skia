...
bool SkRasterizer::rasterizeGPU(GrContext* context, const SkPath& path,
                                const SkMatrix& matrix,
...
bool SkRasterizer::onRasterizeGPU(GrContext* context, const SkPath& path,
                                  const SkMatrix& matrix,
                                  const SkIRect* clipBounds,
                                  bool doAA, SkStrokeRec* stroke,
                                  GrTexture** result,
                                  SkMask::CreateMode mode) const {
    return false;
}
