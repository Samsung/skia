...
#
{
    'sources': [
        ...
        '<(skia_src_path)/core/SkShapeStrokerPriv.cpp',
        '<(skia_src_path)/core/SkShapeStrokerPriv.h',
        '<(skia_src_path)/core/SkShapeStroke.h',
        '<(skia_src_path)/core/SkShapeStroke.cpp',
