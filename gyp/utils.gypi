...
#
{
    'sources': [
        ...
        '<(skia_include_path)/utils/SkLightDeferredCanvas.h',
        ...
        '<(skia_src_path)/utils/SkLightDeferredCanvas.cpp',
        '<(skia_src_path)/utils/SkRecordQueue.h',
        '<(skia_src_path)/utils/SkRecordQueue.cpp',
