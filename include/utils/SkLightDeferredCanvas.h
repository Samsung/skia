...
public:
    ...
    virtual void translate(SkScalar dx, SkScalar dy) SK_OVERRIDE;
    virtual void scale(SkScalar sx, SkScalar sy) SK_OVERRIDE;
    virtual void rotate(SkScalar degrees) SK_OVERRIDE;
    virtual void skew(SkScalar sx, SkScalar sy) SK_OVERRIDE;
...
public:
    ...
    public:
         ...
         */
        virtual void commandsAllocatedForRecordingChanged(
            size_t newNumCommands) {}
